...
<style>
    ...
    #create-post-modal .tools-wrapper {
        margin: 10px 0;
    ...
    #create-post-modal .tools-wrapper .tool-item i {
        background-image: url(/assets/icons/icon-strip.png);
    ...
    #create-post-modal .tools-wrapper .tool-item.friends i {
        background-position: 0 -921px;
    }

    #create-post-modal .tools-wrapper .tool-item.media i {
        background-position: 0 -1467px;
    }

    #create-post-modal .tools-wrapper .tool-item.media.pdf i {
        background-image: url(/assets/icons/icon-pdf.png);
        background-position: 0 0;
    }

    #create-post-modal .tools-wrapper .tool-item.media input {
        position: absolute;
        left: 0;
        top: 0;
        opacity: 0;
    ...
    #create-post-modal .tools-wrapper .tool-item.location i {
        background-position: 0 -1488px;
    }

    #create-post-modal .tools-wrapper .tool-item > div {
        width: 100%;
    ...
    #create-post-modal .tools-wrapper .tool-item {
        position: relative;
        overflow: hidden;
        background: #f5f6f7;
        border-radius: 18px;
    ...
    #create-post-modal .tools-wrapper li {
        display: inline-block;
        margin-right: 6px;
    }

    #create-post-modal .content-wrapper .avatar {
        float: left;
        margin: 20px 10px 0 15px;
    }

    #create-post-modal .content-wrapper .avatar img {
        width: 40px;
        border-radius: 50%;
    }

    #create-post-modal .content-wrapper .fields {
        width: 100%;
    ...
    #create-post-modal .button-wrapper {
        clear: both;
        position: relative;
        padding: 0 20px;
    }

    #create-post-modal .button-wrapper .post-btn {
        width: 100px;
    }

    #create-post-modal .group-fields {
        position: relative;
        overflow: hidden;
        padding: 0 8px;
    }

    #create-post-modal .field-group {
        position: relative;
        overflow: hidden;
        border: #c3c8d1 solid 1px;
        margin-bottom: 10px;
        display: none;
    }

    #create-post-modal .field-group input {
        width: 100%;
        border: none;
        margin: 0;
        padding-left: 50px;
    ...
    #create-post-modal .field-group span {
        display: inline-block;
        background: #e2e8f6;
    ...
    #create-post-modal #location-input-wrapper input {
        padding-left: 64px;
    }
    ...
    #files-preview-wrapper, #files-preview-items {
        position: relative;
        overflow: hidden;
    }
...
<div class="middle-content-block" id="create-post-block" style="position:relative;">
    <div class="post-profile-block ui-widget" id="create-post-modal" title="Create Post/Feedback">
        <form action="<?= site_url('post/create'); ?>" method="post" enctype="multipart/form-data">
            <div class="panel-header section-title">
                <span>Create Post</span>
                <select name="feedback_status" class="feedback_status">
                ...
                <div class="tools-wrapper">
                    ...
                    <div class="group-fields">
                        ...
                        <div class="field-group" id="friends-input-wrapper">
                            <span>With</span>
                            <input type="text" name="q" id="usersAutocompelte" value="<?= $q; ?>"
                    ...
                    <ul>
                        <li>
                            <div class="tool-item media">
                                <i class="" alt=""></i>
                                <div title="Upload Photo/Video" data-tooltip-delay="500" data-tooltip-display="overflow"
                                     data-tooltip-content="Photo/Video" data-hover="tooltip" class="_2aha">Photo/Video
                                </div>
                                ...
                                = multiple="" name="feedback_files[]" display="inline" role="button" tabindex="0" type="
                                file" class="" id="feedback_files">
                            </div>
                        </li>
                        <li>
                            <div class="tool-item media pdf">
                                <i class="" alt=""></i>
                                <div data-tooltip-delay="500" data-tooltip-display="overflow"
                                     data-tooltip-content="Photo/Video" data-hover="tooltip" class="_2aha">PDF
                                </div>
                                <input accept="application/pdf" = multiple="" name="feedback_pdf[]" display="inline"role
                                ="button" tabindex="0" type="file" class="" id="feedback_pdf">
                            </div>
                        </li>
                        <li>
                            <div class="tool-item friends tool-item-link" data-target="friends">
                                <i class="" alt=""></i>
                                <div data-tooltip-delay="500" data-tooltip-display="overflow"
                                     data-tooltip-content="Tag Friends" data-hover="tooltip" class="_2aha">Tag Friends
                                </div>
                            </div>
                        </li>
                        <li>
                            <div class="tool-item location tool-item-link" data-target="location">
                                <i class="" alt=""></i>
                                <div data-tooltip-delay="500" data-tooltip-display="overflow"
                                     data-tooltip-content="Tag Friends" data-hover="tooltip" class="_2aha">Check In
                                </div>
                            </div>
                        </li>
                ...
                if (xhr.upload) {
                    xhr.upload.addEventListener('progress', function (event) {
                        ...
                        $("#circle-" + index).circleProgress({
                            ...
                            'animationStartValue': percent2.toFixed(2)
                        });
