...
<style>
    ...
    #create-post-modal .tools-wrapper{margin:10px 0;     border-top: 1px solid #e9ebee;
        margin: 0 12px;
        padding: 8px 0;}
    #create-post-modal .tools-wrapper .tool-item i{background-image:url(/feedbacker_new/assets/icons/icon-strip.png);background-size: auto;
    ...
    #create-post-modal .tools-wrapper .tool-item.media.pdf i{background-image:url(/feedbacker_new/assets/icons/icon-pdf.png); background-position:0 0;}
                ...
                <div class="tools-wrapper">
                    ...
                    <div class="group-fields">
                        ...
                        <div class="field-group" id="friends-input-wrapper">
                            <span>With</span>
                            <input type="text" name="q" id="usersAutocompelte" value="<?=$q; ?>" placeholder="Who are you with?">
                        </div>
