                            ...
                            <tbody>
                                ...
                                foreach ($titles as $title) { 
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="<?=site_url('admin/encrypted/linked_users/'.$title['title_id']); ?>"><?php echo $title['linked_users_count'] ?></a></td>
                                        <!--<td><a href="<?=site_url('admin/encrypted/feedbacks/'.$title['title_id']); ?>"><?php echo $title['feedbacks_count'] ?></a></td>-->
                                        <td><?php echo ($title['is_survey'])? 'Yes':'No'; ?></td>
										<td><?php echo ($title['is_public'])? 'Yes':'No'; ?></td>
                                        <td><?php echo $title['time'] ?></td>
                                        <td>
                                            <a href="<?php echo base_url('admin/encrypted/edit/' . $title['title_id']); ?>" id="edit_btn" title="Edit Feedback">
                                            ...
                                            <a data-href="<?php echo base_url('admin/encrypted/delete/' . $title['title_id']); ?>" id="delete_btn" data-toggle="modal" data-target="#confirm-delete" href="#" title="Delete Feedback">
