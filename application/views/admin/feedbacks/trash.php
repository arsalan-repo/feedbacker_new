            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Deleted Feedbacks</h3>
                                ...
                                foreach ($feedback_list as $feedback) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a data-href="<?php echo base_url('admin/feedbacks/delete_trash/' . $feedback['feedback_id']); ?>" id="delete_btn" data-toggle="modal" data-target="#confirm-delete" href="#" title="Delete Feedback">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                Are you sure want to permanently delete this feedback?
            </div>
...
<script>
    $(function () {
        $("#example1").DataTable({
			...
			"processing": true,
			"paging": true,
			"ajax": "<?=base_url('admin/feedbacks/json_trash_list'); ?>"
			});
