                ...
                <div class="box">
                    <div class="box-header">
                       ...
                       <div class=" pull-right">
                            <a href="<?php echo site_url('admin/questionnaire/add'); ?>" class="btn btn-primary pull-right">Add Survey</a>
                        </div>
                    </div>
                            ...
                            <tbody>
                                ...
                                foreach ($surveys as $survey) { 
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $survey['location'] ?></td> 
                                        <td><?php echo $survey['created'] ?></td>
                                        <td>
                                            <a href="<?php echo base_url('admin/questionnaire/edit/' . $survey['survey_id']); ?>" id="edit_btn" title="View Details">
                                            ...
                                            <a data-href="<?php echo base_url('admin/questionnaire/delete/' . $survey['survey_id']); ?>" id="delete_btn" data-toggle="modal" data-target="#confirm-delete" href="#" title="Delete Survey">
