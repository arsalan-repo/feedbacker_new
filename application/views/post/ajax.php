...
foreach($feedbacks as $row) { ?>
  <div class="post-profile-block" id="post<?=$row['id']; ?>">
   ...
   <?php if(!empty($this->session->userdata['mec_user']['id']) && $row['user_id']==$this->session->userdata['mec_user']['id']): ?>
	<span class="post-options-wrapper"><a href="#" class="post-options-btn" rel="toggle" data-feedback="<?=$row['id']; ?>" data-title="<?=$row['title_id']; ?>"></a></span>
   ...
   <?php } ?>
    ...
    <div class="post-profile-content"> 
        ...
        <div class="post-follow-block"> 
            ...
            <span class="btn btn-default share">
                <a href="<?= site_url('post/share_post/').$row['title_id'] ?>">Share <i class="fa fa-share"></i></a>
            </span>
