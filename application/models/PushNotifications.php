...
//	private static $API_ACCESS_KEY = 'AIzaSyDI53cBRTUvpowMbY5BIf3W95lhjM6Ssww';
	private static $API_ACCESS_KEY = 'AIzaSyDavF74uaoIqreMHMT-O4dLlgVYODJ6WWs';
...
//	}
	...
	public function android($message, $reg_ids, $payload = array(), $type = '') {
        $url = 'https://android.googleapis.com/gcm/send';
        $fields = array(
            'registration_ids' => $reg_ids,
            'data' => array("msg" => $message, 'payload' => $payload),
        );
...
//	}
	...
	public function iOS($data, $devicetoken) {
		...
		$api_acc_key='AIzaSyDI53cBRTUvpowMbY5BIf3W95lhjM6Ssww';
	...
	public function iOS_old($data, $devicetoken) {
