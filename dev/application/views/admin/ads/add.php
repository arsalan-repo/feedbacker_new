                        ...
                        <div class="form-group col-sm-5">
                            ...
                            <select name="show_on" id="show_on" class="form-control ">
                                ...
                                <option value="title">Title Listing</option>
								 <option value="encrypted">Encrypted Title Listing</option>
                            </select>
                        </div>
						...
						<div class="form-group col-sm-5 col-encrypte_title_id">
                            ...
                            <select name="title_id" id="encrypted_title_id" class="form-control select2">
                                ...
                                foreach ($encrypted_title_list as $title) {
                                    ?>
                                    <option value="<?php echo $title['title_id']; ?>"><?php echo $title['title']; ?>(<?=$title['feedbacks_count']; ?>) By <?=$title['name']; ?></option>
                                    <?php
                                }
                                ?>
                            </select>
