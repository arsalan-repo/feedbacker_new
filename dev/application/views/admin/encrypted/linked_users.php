                            ...
                            <tbody>
                                ...
                                foreach ($linked_users as $user) { 
                                    ...
                                    <tr>
                                        ...
                                        <td>                                            
                                            <a data-href="<?php echo base_url('admin/encrypted/remove_linked_user/' .$title_id.'/'.$user['id']); ?>" id="delete_btn" data-toggle="modal" data-target="#confirm-delete" href="#" title="Delete Feedback">
