                            ...
                            <tbody>
                                ...
                                foreach ($feedback_list as $feedback) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo str_replace("\\n","<br>",str_replace("\\r\\n","<br>",$this->emoji->Decode(nl2br($feedback['feedback_cont'])))); ?></td>
                                        ...
                                        <td>
                                            ...
                                            <a data-href="<?php echo base_url('admin/feedbacks/delete/' . $feedback['feedback_id']); ?>" id="delete_btn" data-toggle="modal" data-target="#confirm-delete" href="#" title="Delete Feedback">
