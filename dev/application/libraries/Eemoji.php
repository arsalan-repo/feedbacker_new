...
class Eemoji
{
	...
	public static function emoji_docomo_to_unified(	$text){ return self::emoji_convert($text, 'docomo_to_unified'); }
	public static function emoji_kddi_to_unified(		$text){ return self::emoji_convert($text, 'kddi_to_unified'); }
	public static function emoji_softbank_to_unified(	$text){ return self::emoji_convert($text, 'softbank_to_unified'); }
	public static function emoji_google_to_unified(	$text){ return self::emoji_convert($text, 'google_to_unified'); }
	...
	public static function emoji_unified_to_docomo(	$text){ return self::emoji_convert($text, 'unified_to_docomo'); }
	public static function emoji_unified_to_kddi(		$text){ return self::emoji_convert($text, 'unified_to_kddi'); }
	public static function emoji_unified_to_softbank(	$text){ return self::emoji_convert($text, 'unified_to_softbank'); }
	public static function emoji_unified_to_google(	$text){ return self::emoji_convert($text, 'unified_to_google'); }
	...
	public static function emoji_unified_to_html($text){
		self::$emoji_maps['html_to_unified'] = array_flip(self::$emoji_maps['unified_to_html']);
		return preg_replace_callback(self::$emoji_maps['unified_rx'], function($m){
			if (isset($m[2]) && $m[2] == "\xEF\xB8\x8E") return $m[0];
			$cp = self::$emoji_maps['unified_to_html'][$m[1]];
	...
	public static function emoji_html_to_unified($text){
		...
		return preg_replace_callback("!<span class=\"emoji-outer emoji-sizer\"><span class=\"emoji-inner emoji([0-9a-f]+)\"></span></span>!", function($m){
			if (isset(self::$emoji_maps['html_to_unified'][$m[1]])){
				return self::$emoji_maps['html_to_unified'][$m[1]];
			}
			return $m[0];
		}, $text);
	}
	...
	public static function emoji_contains_emoji($text){
		self::$emoji_maps['html_to_unified'] = array_flip(self::$emoji_maps['unified_to_html']);
		$count = 0;
		str_replace(self::$emoji_maps['prefixes'], '00', $text, $count);
		return $count > 0;
	}
}
